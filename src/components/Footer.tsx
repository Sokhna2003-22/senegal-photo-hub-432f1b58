...
export function Footer() {
  return (
    <footer className="bg-navy-deep text-white/80 mt-20">
      <div className="container mx-auto px-4 py-12 grid gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-4">
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed">
            La plateforme des photographes professionnels sénégalais.
          </p>
          <div className="mt-4 space-y-2 text-sm">
            ...
            <div className="flex items-center gap-2">
              ...
              <span>contact@sunuvision.sn</span>
            </div>
            <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/photographers" className="hover:text-primary transition-colors">Photographes</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link to="/dashboard" className="hover:text-primary transition-colors">Mon espace</Link></li>
            <li><Link to="/orders" className="hover:text-primary transition-colors">Mes commandes</Link></li>
            <li><Link to="/messages" className="hover:text-primary transition-colors">Messagerie</Link></li>
          </ul>
        </div>
      ...
      <div className="border-t border-white/10 py-4 text-center text-xs text-white/50">
        © {new Date().getFullYear()} SunuVision — Sénégal. Tous droits réservés. Fait avec ❤️ au Sénégal
      </div>
    </footer>
  );
}